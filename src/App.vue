  ...
  <div id="app">
    <div id="sidebar">
      ...
      <ul>
        ...
        <router-link to="/about" v-slot="{ href, navigate, isExactActive }" exact>
          <li :class="{ 'active': isExactActive == true }">
            <a :href="href" @click="navigate">
    ...
    <div id="content">
      <div id="content-header" class="page-header">
        <h1>Blockathon Example Project</h1>
      </div>
...
export default {
  ...
  data() {
    return {
      ethereumAddress: process.env.VUE_APP_ETHEREUM_ACCOUNT_ADDRESS.substring(0, 15)
    }
  }
}
</script>
